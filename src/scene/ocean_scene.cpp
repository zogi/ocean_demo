...
void ocean_scene::init(ocean::spectrum *ocean_spectrum, math::real units_per_meter)
{
    ...
    // Ocean
    ocean_surface.set_spectrum(ocean_spectrum);
    ...
    ocean_effect.use();
    ocean_effect.set_parameter("units_per_meter", units_per_meter);
