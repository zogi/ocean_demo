...
template<> inline void shader_effect::set_parameter<GLuint>(const char *param_name, const GLuint& value) const
{
    glUniform1i(get_param_location(param_name), value);
    GL_CHECK();
}

template<> inline void shader_effect::set_parameter<GLfloat>(const char *param_name, const GLfloat& value) const
{
    glUniform1f(get_param_location(param_name), value);
    GL_CHECK();
}

template<> inline void shader_effect::set_parameter<math::ivec2>(const char *param_name, const math::ivec2& value) const
{
    glUniform2i(get_param_location(param_name), value.x, value.y);
    GL_CHECK();
}
template<> inline void shader_effect::set_parameter<math::ivec3>(const char *param_name, const math::ivec3& value) const
{
    glUniform3i(get_param_location(param_name), value.x, value.y, value.z);
    GL_CHECK();
}
template<> inline void shader_effect::set_parameter<math::ivec4>(const char *param_name, const math::ivec4& value) const
{
    glUniform4i(get_param_location(param_name), value.x, value.y, value.z, value.w);
    GL_CHECK();
}

template<> inline void shader_effect::set_parameter<math::vec2>(const char *param_name, const math::vec2& value) const
{
    glUniform2f(get_param_location(param_name), value.x, value.y);
    GL_CHECK();
}
template<> inline void shader_effect::set_parameter<math::vec3>(const char *param_name, const math::vec3& value) const
{
    glUniform3f(get_param_location(param_name), value.x, value.y, value.z);
    GL_CHECK();
}
template<> inline void shader_effect::set_parameter<math::vec4>(const char *param_name, const math::vec4& value) const
{
    glUniform4f(get_param_location(param_name), value.x, value.y, value.z, value.w);
    GL_CHECK();
}

template<> inline void shader_effect::set_parameter<math::mat3>(const char *param_name, const math::mat3& value) const
{
    glUniformMatrix3fv(get_param_location(param_name), 1, GL_FALSE, math::value_ptr(value));
    GL_CHECK();
}
template<> inline void shader_effect::set_parameter<math::mat4>(const char *param_name, const math::mat4& value) const
{
