...
public:
    ...
    static surface create_8bit_paletted(const util::extent& extent) { return SDL_CreateRGBSurface(0, extent.width, extent.height, 8, 0, 0, 0, 0); }
    static surface create_32bit_rgba(const util::extent& extent) { return SDL_CreateRGBSurface(0, extent.width, extent.height, 32, 0, 0, 0, 0xff); }
