...
public:
    ...
    mouse_button get_mouse_button() const { return static_cast<mouse_button>(api_event.button.button); }
...
public:
    ...
    mouse_button_state get_mouse_move_button_state() const { return static_cast<mouse_button_state>(api_event.motion.state); }
...
public:
    ...
    bool is_mouse_button_event() const { return api_event.type == SDL_MOUSEBUTTONDOWN || api_event.type == SDL_MOUSEBUTTONUP; }
    bool is_window_resize_event() const { return api_event.type == SDL_WINDOWEVENT && api_event.window.event == SDL_WINDOWEVENT_RESIZED; }
    bool is_quit_event() const { return api_event.type == SDL_QUIT || api_event.type == SDL_APP_TERMINATING; }
